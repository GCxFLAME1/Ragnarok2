...
bot = telebot.TeleBot('8078178386:AAFmKgipbn1gLIEv67GObLP5snVDDmyP4fc')
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 300:
                ...
                response = f"FLAMECHEATSOP🚀\nAttack1 Finished. \n📡 Target: {target} \n🔌 Port: {port} \n⏱️ Time: {time} \n BY https://t.me/FLAMECHEATSOP"
        else:
            response = "Usage :- /attack1 <target> <port> <time>\nBy https://t.me/FLAMECHEATSOP"  # Updated command syntax
    else:
        response = "You Are Not User's To Authorized To Use This Command.\nBy STORM BOT DM TO GET ACCESS @GCxFLAME"
